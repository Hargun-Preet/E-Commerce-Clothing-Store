    ...
    <div className="container xl:px-[9rem] sm:px-[0] ">
        <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-3/4 p-3">
                <div className="h-12 font-semibold">Create Product</div>

                {imageUrl && (
                    <div className="text-center">
                        <img src={imageUrl} alt="product" className="block mx-auto max-h-[200px] mb-4" />
                    </div>
                )}
                ...
                <div className="p-3 ">
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="ml-20">
                            ...
                            <select placeholder="Choose a Category" className="p-4 mb-3 w-[24rem] border rounded-lg bg-[#101011] text-white" onChange={e => setCategory(e.target.value)}>
                                {categories?.map((c) => (
                    ...
                    className="py-3 px-10 mt-5 rounded-lg text-lg font-bold bg-pink-600">Submit</button>
                </div>
            </div>
        </div>
    </div>
