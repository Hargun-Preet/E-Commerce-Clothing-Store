        ...
        <div className="mr-[4rem] mt-[5rem]">
            ...
            <form onSubmit={submitHandler} className="container w-[40rem]">
                ...
                <div className="my-[2rem]">
                    ...
                    <input type="email" id = "email" className="mt-1 p-2 border rounded w-full" placeholder="Enter Your E-mail Adderess" value = {email} onChange={e => setEmail(e.target.value)} />
                </div>
                ...
                <button disabled= {isLoading} className="bg-pink-500 text-white px-4 py-2 rounded cursor-pointer my-[1rem]" type="submit">{isLoading ? "Registering..." : "Register"}</button>
